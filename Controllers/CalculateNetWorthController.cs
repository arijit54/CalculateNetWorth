...
namespace CalculateNetWorth.Controllers
{
    ...
    public class CalculateNetWorthController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetStockByCustomerAsync(Customer customer)
        {
            if (customer == null)
            {
                return BadRequest();
        ...
        public async Task<ActionResult> GetMutualFundByCustomerAsync(Customer customer)
        {
            if (customer == null)
            {
                return BadRequest();
        ...
        [HttpPost]
        public async Task<ActionResult> calculateNetWorth([FromBody] Customer customer)
        {
            if (customer == null)
            {
                return BadRequest();
